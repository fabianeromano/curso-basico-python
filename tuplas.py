...
# frutas = citricos.extend(tropical) # esto no funciona porque extend no es un método de tuplas
# frutas = citricos.append(tropical) # esto no funciona porque append no es un método de tuplas