...
diccionario = {
    "nombre": "Fabian Romano",
    "youtube": "www.youtube.com/@fabianeromano",
...
contructorDiccionario = dict(nombre = "Sergie Code", youtube = "www.youtube.com/@sfabianeromano") # Se puede crear con constructor
